...
SECRET_KEY = 'django-insecure-__o%3#y^c0v1&ooij1!x)_bdli03z(m714o$!u-z%x+6(zo$cl'
...
EMAIL_HOST_USER = 'tillureddy382@gmail.com'  # Sender's email address
EMAIL_HOST_PASSWORD = 'banp rbjj yzcn gkic' 
...
LOGIN_REDIRECT_URL = 'user_dashboard'  # Default dashboard, usually user dashboard

AUTHENTICATION_BACKENDS = [
    'app.backends.CustomAuthBackend',  # Replace with your actual custom backend path
